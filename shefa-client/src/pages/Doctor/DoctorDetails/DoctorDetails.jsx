...
about: "এই ডাক্তার একজন উচ্চ অভিজ্ঞতাসম্পন্ন হৃদরোগ বিশেষজ্ঞ, যার ২৫ বছরের বেশি রোগী সেবা অভিজ্ঞতা রয়েছে। তিনি হৃদরোগ, উচ্চ রক্তচাপ এবং কার্ডিয়াক সমস্যার ক্ষেত্রে বিশেষজ্ঞ।\nপ্রতিটি রোগীর প্রতি ব্যক্তিগত মনোযোগ প্রদান করে সুপরিকল্পিত চিকিৎসা নিশ্চিত করেন। নতুন এবং জটিল ক্ষেত্রে সর্বশেষ চিকিৎসা পদ্ধতি ব্যবহার করে রোগীদের দ্রুত আরোগ্য নিশ্চিত করা তার লক্ষ্য।",  experienceDetails: [
  ...
  {
    name: "রাহিম উদ্দিন",
    image: "https://static.vecteezy.com/system/resources/previews/003/316/958/non_2x/religious-muslim-man-praying-free-vector.jpg",
    comment: "ডাক্তার খুব মনোযোগ দিয়ে কথা শুনেন এবং সঠিক চিকিৎসা দেন। অনেক উপকার পেয়েছি।",
    rating: 5,
  },
  {
    name: "করিম শেখ",
    image: "https://img.freepik.com/premium-vector/muslim-man-avatar-holding-bag-illustration_591903-629.jpg?w=360",
    comment: "চিকিৎসা ভালো ছিল, তবে একটু অপেক্ষা করতে হয়েছে। তারপরও সন্তুষ্ট।",
    rating: 4,
  },
  {
    name: "সুমাইয়া আক্তার",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZ1KkruwQUGHdYzl5AU3mN11wx0oSrfx3HAg&s",
    comment: "অনেক ভদ্র এবং অভিজ্ঞ ডাক্তার। রিপোর্ট ভালোভাবে বুঝিয়ে দিয়েছেন।",
    rating: 5,
  },
  {
    name: "মোঃ হাসান আলী",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvi1l7YaK7LCqdfQjmaK09kFInKVdZGxNHWw&s",
    comment: "সার্ভিস ভালো, কিন্তু সময় মেনে আসেননি। তবুও চিকিৎসা ভালো লেগেছে।",
    rating: 4,
  },
  {
    name: "নুসরাত জাহান",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAyqv6kr6hzSf_qoLh128h7yV8yg_QJHnwPA&s",
    comment: "আমি আগে অনেক জায়গায় দেখিয়েছি, কিন্তু এখানে এসে ভালো ফল পেয়েছি। ধন্যবাদ।",
    rating: 5,
  },
],
    schedule: [
...
<div className="absolute top-4 right-4 flex gap-2">
  ...
  <button
    ...
    transition-all duration-200"
  >
    <Share2 size={16} className="hover:rotate-12 transition-transform duration-200" />
  </button>

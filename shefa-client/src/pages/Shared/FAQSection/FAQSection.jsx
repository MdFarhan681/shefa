...
const faqs = [
  {
    ...
    answer:
      "ডাক্তারের ধরন ও সেবার ওপর পরামর্শ ফি নির্ভর করে। শেফা সাশ্রয়ী ও স্বচ্ছ মূল্যে অনলাইন চিকিৎসা সেবা দেওয়ার চেষ্টা করে।"
  },
  {
    question: "আপনারা কি স্বাস্থ্য বীমা গ্রহণ করেন?",
    answer:
      "বর্তমানে শেফা সরাসরি স্বাস্থ্য বীমা গ্রহণ করে না। তবে পরামর্শের রসিদ আপনার বীমা প্রতিষ্ঠানে জমা দিয়ে রিম্বার্সমেন্ট নেওয়া যেতে পারে।"
  },
  {
  ...
  {
    question: "শেফা কি ২৪/৭ সেবা দেয়?",
    answer:
  ...
  },
  {
    ...
    answer:
      "হ্যাঁ, শেফা রোগীর তথ্যের গোপনীয়তা ও নিরাপত্তা নিশ্চিত করতে আধুনিক ডিজিটাল নিরাপত্তা ব্যবস্থা ব্যবহার করে।"
  }
];
